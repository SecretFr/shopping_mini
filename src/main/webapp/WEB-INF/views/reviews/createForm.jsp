...
<form class="form-horizontal" 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" name="revtitle" id="revtitle" class="form-control">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" name="revwriter" id="revwriter" class="form-control">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
    <textarea rows="12" cols="7" id="revcontent" name="revcontent" class="form-control"></textarea>
    </div>
  </div>
