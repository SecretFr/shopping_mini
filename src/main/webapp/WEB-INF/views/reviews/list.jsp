...
<c:when test="${empty list}">
   <tr><td colspan="6">등록된 후기가 없습니다.</td>
</c:when>
<c:otherwise>
   ...
   <tr>
    ...
    <td>${dto.pname}</td>
    <td><a href="javascript:read('${dto.reviewno}')">${dto.revtitle}</a>
    <c:if test="${util:newImg(fn:substring(dto.revdate,0,10)) }">
         <img src="/images/new.gif"> 
    </c:if> 
    </td>
    <td>${dto.revwriter}</td>
    <td>${dto.revdate}</td>
    <td> <a href="./update/${dto.reviewno }">
          <span class="glyphicon glyphicon-edit"></span>
        </a>
        /
        <a href="./delete/${dto.reviewno }">
